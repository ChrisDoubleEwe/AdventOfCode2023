...
def move():
  ...
  while len(myqueue) > 0:
    ...
    if h > route[y][x][dir]:
      #print "been here sooner, At " + str(y) + "," + str(x) + ' in dir ' + d + " heat: " + str(h) + " (previous best: " + str(route[y][x]) + ") : " + r

      continue
    if h < route[y][x][dir]:
      route[y][x][dir] = h
      #print "New fastest route here, At " + str(y) + "," + str(x) + ' in dir ' + d + " heat: " + str(h) + " (previous best: " + str(route[y][x]) + ") : " + r
